document.querySelectorAll('[data-tabs-toggle]').forEach(function(tabsToggleEl) {
    ...
    tabsToggleElements.forEach(function(tabToggleEl) {
        tabToggleEl.addEventListener('click', function(event) {
            ...
            var tabContentEl = document.querySelector(
            tabTargetSelector); // don't do anything if it's already active
            ...
            if (tabToggleEl !== activeTabToggleEl) {
                ...
                if (!activeTabToggleEl && !activeTabContentEl) {
                    activeTabToggleEl = document.querySelector('#' + tabsToggleElementsId +
                        ' [aria-selected="true"]');
                    activeTabContentEl = document.querySelector(activeTabToggleEl
                ...
                tabContentEl.classList.remove(
                'hidden'); // hide and deactive currently active tab toggle and content
                ...
                'hidden'); // set currently active toggle and content tabs
