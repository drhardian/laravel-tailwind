...
@section('content')
        ...
        <div class="p-4 mt-2">
            ...
            <div class="flex justify-between mb-7">
                ...
                <button type="button" id="newActivityBtn"
                    onclick="openFormActivity(`{{ route('activity.store') }}`)"
    ...
    <button onclick="openFormActivity(`{{ route('activity.store') }}`)"
    ...
    <!-- New Activity modal -->
    <div id="newActivityModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" role="dialog" aria-modal="true"
                    ...
                    <form id="activityForm" method="post">
                        ...
                        <div class="mb-6">
                            <label for="activity_code"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Code/Alias</label>
                            <input type="text" id="activity_code" name="activity_code"
                                ...
                                placeholder="Activity Code/Alias" required>
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <label for="unit_rate_id"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit Rate</label>
                            <select class="select2-ajax" id="unit_rate_id" name="unit_rate_id[]" multiple="multiple">
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('core/js/request_order/activity-custom.js') }}"></script>
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#unit_rate_id').select2({
                ajax: {
                    url: "{{ route('unitrate.show.dropdown') }}",
                    type: 'GET',
                    dataType: 'json',
                    delay: 250,
