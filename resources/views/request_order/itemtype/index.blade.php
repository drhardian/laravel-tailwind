        ...
        <div class="p-4 mt-2">
            ...
            <div class="flex justify-between mb-7">
                ...
                <button type="button" id="newBtn"
                    onclick="openForm(`{{ route('itemtype.store') }}`)"
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('core/js/request_order/itemtype-custom.js') }}"></script>
    <script>
