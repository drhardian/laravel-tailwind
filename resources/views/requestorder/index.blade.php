                            ...
                            <div class="row sm:flex">
                                <div class="sm:w-1/2 w-full sm:pr-2">
                                    ...
                                    <div class="relative max-w-sm">
                                        ...
                                        <input datepicker id="start_date" datepicker-format="dd/mm/yyyy" name="start_date" type="text"
                                ...
                                <div class="sm:w-1/2 w-full sm:pl-2 sm:pt-0 pt-6">
                                    ...
                                    <div class="relative max-w-sm">
                                        ...
                                        <input datepicker id="end_date" datepicker-format="dd/mm/yyyy" name="end_date" type="text"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Select date">
                                    </div>
                                </div>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('core/js/requestorder-custom.js') }}"></script>
    <script>
