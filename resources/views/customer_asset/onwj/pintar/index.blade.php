                ...
                <table id="main-table" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <!--3--><th>Well Name</th>
                            <!--4--><th>Tag#</th>
                            <!--33--><th>Remote System</th>
                            <!--34--><th>Modification</th>
                            <!--35--><th>Integrity Status</th>
                            <!--36--><th>Control Valve Status</th>
                            <!--37--><th>RTU</th>
                            <!--38--><th>Meter</th>
                            <!--39--><th>Power System</th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#main-table').DataTable({
                ...
                deferRender: true,
                ajax: {
                    url: "{{ route('onwj.pintar.main.table') }}",
                },
                columns: [
                    /*0*/{ data: 'area', name: 'area' },
                    /*1*/{ data: 'subarea', name: 'subarea', },
                    /*2*/{ data: 'platform', name: 'platform', },
                    /*3*/{ data: 'wellname', name: 'wellname', },
                    /*4*/{ data: 'tagnumber', name: 'tagnumber', },
                    /*5*/{ data: 'remotesystem', name: 'remotesystem', },
                    /*6*/{ data: 'modification', name: 'modification', },
                    /*7*/{ data: 'integritystatus', name: 'integritystatus', },
                    /*8*/{ data: 'controlvalvestatus', name: 'controlvalvestatus', },
                    /*9*/{ data: 'rtu', name: 'rtu', },
                    /*10*/{ data: 'meter', name: 'meter', },
                    /*11*/{ data: 'powersystem', name: 'powersystem', },
                ],
                columnDefs: [
                    { className: "dt-center", target: [0,1,2,3,4,5,6,7,8] },
                    { className: "tablet-1", target: [9,10,11] },
                ],
                order: []
            });
        });
        ...
        function uploadFile() {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('onwj.pintar.data.import') }}",
                data: formData,
                dataType: "json",
                contentType: false,
                processData: false,
