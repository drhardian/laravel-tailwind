...
@section('content')
    <div class="min-h-screen w-full mx-auto max-w-4xl lg:max-w-7xl space-y-2 p-5">
        ...
        <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
            <div class="mb-6 text-right border-b-2 pb-2">
                <label class="inline-flex items-center cursor-pointer">
                    <span class="mr-3 text-sm font-medium text-gray-900 dark:text-gray-300">All Status</span>
                    <input type="checkbox" id="chkActiveView" class="sr-only peer" {{ !isset($active) ?: "checked" }}>
                    <div
