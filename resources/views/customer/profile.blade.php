                ...
                <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div
                            ...
                            <a href="#">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $contract->description }}</h5>
                            </a>
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $contract->details }}</p>
                            <a href="#"
