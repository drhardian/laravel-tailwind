    ...
    <div class="min-h-screen w-full mx-auto max-w-4xl lg:max-w-7xl">
        <div class="p-4 mt-2">
            ...
            <div class="flex justify-between mb-7">
                ...
                <button type="button" onclick="openForm(`{{ route('tablemap.store') }}`)"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 space-y-6">
                    ...
                    <form id="mainForm" method="post">
                        @csrf
                        <h3 class="mb-4 text-lg font-medium leading-none text-gray-900 dark:text-white">GENERAL INFORMATION
                        </h3>
                        <div class="mb-6">
                            <div class="row sm:flex">
                                ...
                                <div class="sm:w-1/2 w-full sm:pl-2 sm:pt-0 pt-6">
                                    ...
                                    <select id="work_type" name="work_type"
                                        ...
                                        @foreach ($vrr_dropdown as $workType)
                                            @if ($workType->dropdown_category == 'work_type')
                                                <option value="{{ $workType->id }}">{{ $workType->dropdown_label }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                    ...
                                    <label for="scope_of_work"
                                        class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white">Scope of
                                        Work</label>
                                    <input type="text" id="scope_of_work" name="scope_of_work"
                                        class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Scope of Work">
                                    <label for="repair_type"
                                        class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white">Repair
                                        Type</label>
                                    <input type="text" id="repair_type" name="repair_type"
                                        class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="mb-6">
                            <div
                                ...
                                <label for="field_diagnostic_only_job"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Field Diagnostic
                                    only job</label>
                                ...
                                <div class="row sm:flex">
                                    <div class="sm:w-1/2 w-full sm:pr-2">
                                        ...
                                        <input type="text" id="ltsa_title" name="ltsa_title"
                                            class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required placeholder="LTSA Title">
                                        <label for="ltsa_ref"
                                        ...
                                        <label for="RO Date"
                                            class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white">Email
                                            Address</label>
                                        <input type="date" id="RO Date" name="RO Date"
                                            class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="RO Date">
                                    ...
                                    <div class="sm:w-1/2 w-full sm:pl-2 sm:pt-0 pt-6">
                                        ...
                                        <input type="text" id="ltsa_manager" name="ltsa_manager"
                                            class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required placeholder="LTSA Manager">
                                        ...
                                        <input type="text" id="other_ptcs_personel" name="other_ptcs_personel"
                                            class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        ...
                                        <input type="text" id="other_customer_personel" name="other_customer_personel"
                                            class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
