            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 space-y-6">
                    ...
                    <form id="mainForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-0 dark:bg-gray-800" id="generalInformation"
                                    ...
                                    <div class="row sm:flex">
                                        <div class="sm:w-1/2 w-full sm:pr-2">
                                            ...
                                            <input type="text" id="customer" name="customer"
                                                ...
                                                value="{{ $valverepair->customer }}" required
                                        ...
                                        <div class="sm:w-1/2 w-full sm:pl-2 sm:pt-0 pt-6">
                                            ...
                                            <select id="work_type" name="work_type" required
                                                ...
                                                <option {{ $valverepair->work_type == '' ? 'selected' : '' }}
                                                    value="" disabled>Choose a order type</option>
                                                @foreach ($vrr_dropdown as $workType)
                                                    @if ($workType->dropdown_category == 'work_type')
                                                        <option
                                                            {{ $valverepair->work_type == $workType->id ? 'selected' : '' }}
                                                            value="{{ $workType->id }}">
                                            ...
                                            <select id="order_type" name="order_type" onchange="showHideDiv()"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option {{ $valverepair->order_type == '' ? 'selected' : '' }}
                                                    value="" disabled>Choose a order type</option>
                                                @foreach ($vrr_dropdown as $workType)
                                                    @if ($workType->dropdown_category == 'order_type')
                                                        <option
                                                            {{ $valverepair->order_type == $workType->id ? 'selected' : '' }}
                                                            value="{{ $workType->id }}">
                                                            {{ $workType->dropdown_label }}
                                                        </option>
                                                    @endif
                                            ...
                                            <select id="scope_of_work" name="scope_of_work"
                                                ...
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option {{ $valverepair->scope_of_work == '' ? 'selected' : '' }}
                                                    value="" disabled>Choose a order type</option>
                                                @foreach ($vrr_dropdown as $workType)
                                                    @if ($workType->dropdown_category == 'sow')
                                                        <option
                                                            {{ $valverepair->scope_of_work == $workType->id ? 'selected' : '' }}
                                                            value="{{ $workType->id }}">
                                                            {{ $workType->dropdown_label }}
                                                        </option>
                                                    @endif
                                            ...
                                            <div id="repair_type_div" class="hidden">
                                                ...
                                                <select id="repair_type" name="repair_type"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <option {{ $valverepair->repair_type == '' ? 'selected' : '' }}
                                                        value="" disabled>Choose a order type</option>
                                                    @foreach ($vrr_dropdown as $workType)
                                                        @if ($workType->dropdown_category == 'repair_type')
                                                            <option
                                                                {{ $valverepair->repair_type == $workType->id ? 'selected' : '' }}
                                                                value="{{ $workType->id }}">
                                                                {{ $workType->dropdown_label }}
                                                            </option>
                                                        @endif
                                            ...
                                            <div
                                                ...
                                                <input type="text" id="performed_by" name="performed_by"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->performed_by }}" required
                                                ...
                                                <input type="text" id="title_performed" name="title_performed"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->title_performed }}"
                                                ...
                                                <input type="text" id="email_address_performed"
                                                    ...
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->email_address_performed }}"
                                ...
                                <div class="mb-6">
                                    <div
                                        ...
                                        <div class="row sm:flex">
                                            <div class="sm:w-1/2 w-full sm:pr-2">
                                                ...
                                                <input type="date" id="start_date" name="start_date"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->start_date }}" required
                                            ...
                                            <div class="sm:w-1/2 w-full sm:pr-2">
                                                ...
                                                <input type="date" id="estimate_end_date" name="estimate_end_date"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->estimate_end_date }}" required
                                                    placeholder="Estimate end Date">
                                            </div>
                                        ...
                                        <select id="field_diagnostic_only_job" name="field_diagnostic_only_job"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option
                                                {{ $valverepair->field_diagnostic_only_job == '' ? 'selected' : '' }}
                                                value="" disabled>Choose a Option</option>
                                            <option
                                                {{ $valverepair->field_diagnostic_only_job == 1 ? 'selected' : '' }}
                                                value=1>Yes</option>
                                            <option
                                                {{ $valverepair->field_diagnostic_only_job == 0 ? 'selected' : '' }}
                                                value=0>No</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="row sm:flex">
                                            <div class="sm:w-1/2 w-full sm:pr-2">
                                                ...
                                                <input type="text" id="ltsa_title" name="ltsa_title"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->ltsa_title }}"
                                                ...
                                                <input type="text" id="ltsa_ref" name="ltsa_ref"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->ltsa_ref }}"
                                                    placeholder="Contact Person">
                                                <label for="ro_number"
                                                ...
                                                <input type="text" id="ro_number" name="ro_number"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->ro_number }}"
                                                ...
                                                <input type="date" id="ro_date" name="ro_date"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->ro_date }}" placeholder="RO Date">
                                            ...
                                            <div class="sm:w-1/2 w-full sm:pl-2 sm:pt-0 pt-6">
                                                ...
                                                <input type="text" id="ltsa_manager" name="ltsa_manager"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->ltsa_manager }}"
                                                ...
                                                <input type="text" id="workshop_lead" name="workshop_lead"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->workshop_lead }}"
                                                ...
                                                <input type="text" id="engineering_lead" name="engineering_lead"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->engineering_lead }}"
                                                ...
                                                <input type="text" id="qc_inspector" name="qc_inspector"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->qc_inspector }}"
                                                ...
                                                <input type="text" id="painting_operator" name="painting_operator"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->painting_operator }}"
                                                ...
                                                <input type="text" id="ndt_level" name="ndt_level"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->ndt_level }}"
                                                ...
                                                <input type="text" id="other_ptcs_personel"
                                                    ...
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->other_ptcs_personel }}"
                                                ...
                                                <input type="text" id="qc_representative" name="qc_representative"
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->qc_representative }}"
                                                ...
                                                <input type="text" id="other_customer_personel"
                                                    ...
                                                    class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    value="{{ $valverepair->Ltsa->other_customer_personel }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Write note here..." id="note" name="note">{{ $valverepair->note }}</textarea>
                                </div>
                                    ...
                                    <div class="row sm:flex">
                                        <div class="sm:w-1/2 w-full sm:pr-2">
                                            ...
                                            <select id="device_type" name="device_type" required
                                                ...
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option
                                                    {{ $valverepair->deviceDetail->device_type == '' ? 'selected' : '' }}
                                                    value="" disabled>Choose a Device Type</option>
                                                @foreach ($vrr_dropdown as $device_type)
                                                    @if ($device_type->dropdown_category == 'device_type')
                                                        <option
                                                            {{ $valverepair->deviceDetail->device_type == $device_type->id ? 'selected' : '' }}
                                                            value="{{ $device_type->id }}">
                                                            {{ $device_type->dropdown_label }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                            </select>
                                            ...
                                            <select id="selected_device_type" name="selected_device_type" required
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option
                                                    {{ $valverepair->deviceDetail->device_type_selected_type == '' ? 'selected' : '' }}
                                                    value="" disabled>Choose a device type</option>
                                                @foreach ($vrr_dropdown as $selected_device_type)
                                                    @if ($selected_device_type->dropdown_category == 'selected_device_type')
                                                        <option
                                                            {{ $valverepair->deviceDetail->device_type_selected_type == $device_type->id ? 'selected' : '' }}
                                                            value="{{ $selected_device_type->id }}">
                                                            {{ $selected_device_type->dropdown_label }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                            </select>
                                            ...
                                            <input type="text" id="tag_number" name="tag_number"
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                value="{{ $valverepair->deviceDetail->tag_number }}"
                                                placeholder="Add Other customer personel">
                                            ...
                                            <input type="text" id="serial_number" name="serial_number"
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                value="{{ $valverepair->deviceDetail->serial_number }}"
                                            ...
                                            <select id="process" name="process" required
                                                ...
                                                <option
                                                    {{ $valverepair->deviceDetail->device_type_selected_type == '' ? 'selected' : '' }}
                                                    value="" disabled>Choose a Process</option>
                                                @foreach ($vrr_dropdown as $process_data)
                                                    @if ($process_data->dropdown_category == 'process_device_detail')
                                                        <option
                                                            {{ $valverepair->deviceDetail->process == $process_data->id ? 'selected' : '' }}
                                                            value="{{ $process_data->id }}">
                                                            {{ $process_data->dropdown_label }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="sm:w-1/2 w-full sm:pr-2">
                                            ...
                                            <input
                                                ...
                                                id="photo_devices" name="photo_devices[]" type="file"
                                                onchange="preview_image();" multiple>
                                            <div id="image_preview" class="grid grid-cols-4 gap-4 mt-4">
                                                @foreach ($valverepair->Files as $image_edit)
                                                    @php
                                                        $nameFile = $image_edit->name;
                                                        $nameFileSpaces = str_replace(' ', '', $nameFile);
                                                        $fileNameWithoutExtension = pathinfo($nameFileSpaces, PATHINFO_FILENAME);
                                                        $imageId = 'image-item-' . $fileNameWithoutExtension;
                                                    @endphp

                                                    <div id="{{ $imageId }}"
                                                        class="image-item flex flex-col items-center">
                                                        <img src="{{ asset('images/ValveRepair/' . $valverepair->id . '/' . $image_edit->name) }}"
                        ...
                        <input type="hidden" value="{{ $valverepair->deviceDetail->device_type_selected_type }}"
                            name="selected_device_type_value" id="selected_device_type_value">
