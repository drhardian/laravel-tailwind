    ...
    <!-- New modal -->
    <div id="sowModal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" role="dialog" aria-modal="true"
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white modal-title-sow"></h3>
                    <button type="button" id="closeSow"
                ...
                <div class="px-6 space-y-6 mb-4">
                    ...
                    <!-- URL Area -->
                    <input type="hidden" id="form_url_sow" readonly>
                    <!-- Form Area -->
                    <form id="mainFormSow" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="repair_report_id_sow" id="repair_report_id_sow">
                        <label for="scope_of_work"
                            class="block mb-2 mt-4 text-sm font-medium text-gray-900 dark:text-white">Scope
                            of
                            Work</label>
                        <select id="scope_of_work" name="scope_of_work_id" onchange="scope_of_workDiv()"
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        onClick="saveRecordSow()">Save</button>
                    <button id="cancelBtnSow" type="button"
