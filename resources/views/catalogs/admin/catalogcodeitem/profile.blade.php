    ...
    <div class="min-h-screen w-full mx-auto max-w-4xl lg:max-w-7xl">
        <div class="p-4 mt-2">
            ...
            <div class="flex justify-between mb-7">
                ...
                @endunless
                {{-- <a href="{{ route('catalogcodeitem.pdf', ['id' => $catalogcodeitem->id]) }}" class="text-white bg-blue-700 hidden sm:block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <div
                    ...
                    <div id="myTabContent">
                        ...
                        <div class id="general" role="tab" aria-labelledby="general-tab">
                            <div class="space-y-6">
                                <div class="mb-6">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ITEM
                                        CODE</label>
                                    <div class="row sm:flex">
                                        <div class="w-1/4">
                                            ...
                                            <div
                                                ...
                                                @if ($catalogcodeitem->main_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->main_code }}</div>
                                                @else
                                        ...
                                        <div class="w-3/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->titlemain_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->titlemain_code }}</div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                            </div>
                                    ...
                                    <div class="row sm:flex">
                                        <div class="w-1/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->code)
                                                    <div class="form-control form-control-solid">{{ $catalogcodeitem->code }}
                                                    </div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                        ...
                                        <div class="w-3/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->title_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->title_code }}</div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                            </div>
                                    ...
                                    <div class="row sm:flex">
                                        <div class="w-1/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->sub_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->sub_code }}</div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                            </div>
                                        ...
                                        <div class="w-3/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->titlesub_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->titlesub_code }}</div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                            </div>
                                    ...
                                    <div class="row sm:flex">
                                        <div class="w-1/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->group_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->group_code }}</div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                            </div>
                                        ...
                                        <div class="w-3/4">
                                            ...
                                            <div
                                                class="bg-gray-50 sm:p-2 p-1.5 border border-gray-300 text-gray-900 sm:text-base text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                @if ($catalogcodeitem->titlegroup_code)
                                                    <div class="form-control form-control-solid">
                                                        {{ $catalogcodeitem->titlegroup_code }}</div>
                                                @else
                                                    <div class="form-control form-control-solid">N/A</div>
                                                @endif
                                            </div>
