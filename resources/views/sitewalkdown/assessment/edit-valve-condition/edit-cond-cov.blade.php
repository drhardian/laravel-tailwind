                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative flex items-stretch w-full">
                                        ...
                                        <span class="input-group-append">
                                            <button type="button"
                                                class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded bg-gray-800 text-white py-3 px-3 leading-normal no-underline btn-gray"
                            ...
                            <div class="lg:w-1/2 pr-4 pl-4 md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="valve_condition_2" name="valve_condition_2"
                                        ...
                                        @if (!empty($assessmentDetail->bonnet_condition))
                                            <option value="{{ $assessmentDetail->bonnet_condition }}" selected>
                                                {{ $assessmentDetail->bonnet_condition }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                            ...
                            <div class="lg:w-1/2 pr-4 pl-4 md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_2" name="health_rating_2"
                                        ...
                                        data-change="false">
                                        @if (!empty($assessmentDetail->bonnet_condition_level))
                                            <option value="{{ $assessmentDetail->bonnet_condition_level }}" selected>
                                                {{ $healthRatingByDevice->bonnet }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                            ...
                            <div class="md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="potensial_cause_2" name="potensial_cause_2[]"
                                        ...
                                        data-change="false" multiple>
                                        @if (!empty($assessmentDetail->bonnet_cause))
                                            @foreach (explode('|', $assessmentDetail->bonnet_cause) as $item)
                                                <option value="{{ $item }}" selected>{{ $item }}
                                                </option>
                                            @endforeach
                                        @endif
                            ...
                            <div class="md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="recommendation_2" name="recommendation_2[]"
                                        ...
                                        data-change="false" multiple>
                                        @if (!empty($assessmentDetail->bonnet_recommendation))
                                            @foreach (explode('|', $assessmentDetail->bonnet_recommendation) as $item)
                                                <option value="{{ $item }}" selected>{{ $item }}
                                                </option>
                                            @endforeach
                                        @endif
                            ...
                            <div class="md:w-full">
                                <div class="mb-4">
                                    ...
                                    <div class="relative flex items-stretch w-full">
                                        ...
                                        <span class="input-group-append">
                                            <button type="button"
                                                class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-3 px-3 text-white bg-gray-800 leading-normal no-underline btn-gray"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_3" name="health_rating_3"
                                        ...
                                        @if (!empty($assessmentDetail->bonnetgasket_condition_level))
                                            <option value="{{ $assessmentDetail->bonnetgasket_condition_level }}"
                                                selected>{{ $healthRatingByDevice->bonnetgasket }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_4" name="health_rating_4"
                                        ...
                                        @if (!empty($assessmentDetail->valvebody_condition_level))
                                            <option value="{{ $assessmentDetail->valvebody_condition_level }}"
                                                selected>{{ $healthRatingByDevice->valvebody }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_5" name="health_rating_5"
                                        ...
                                        @if (!empty($assessmentDetail->valvetrim_condition_level))
                                            <option value="{{ $assessmentDetail->valvetrim_condition_level }}"
                                                selected>{{ $healthRatingByDevice->valvetrim }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_7" name="health_rating_7"
                                        ...
                                        @if (!empty($assessmentDetail->actexternal_condition_level))
                                            <option value="{{ $assessmentDetail->actexternal_condition_level }}"
                                                selected>{{ $healthRatingByDevice->actexternal }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="valve_condition_8" name="valve_condition_8"
                                        ...
                                        @if (!empty($assessmentDetail->electricenclosure_condition))
                                            <option value="{{ $assessmentDetail->electricenclosure_condition }}"
                                                selected>{{ $assessmentDetail->electricenclosure_condition }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_8" name="health_rating_8"
                                        ...
                                        @if (!empty($assessmentDetail->electricenclosure_condition_level))
                                            <option
                                                value="{{ $assessmentDetail->electricenclosure_condition_level }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_10" name="health_rating_10"
                                        ...
                                        @if (!empty($assessmentDetail->gearbox_condition_level))
                                            <option value="{{ $assessmentDetail->gearbox_condition_level }}"
                                                selected>{{ $healthRatingByDevice->gearbox }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="valve_condition_11" name="valve_condition_11"
                                        ...
                                        @if (!empty($assessmentDetail->manualoverride_condition))
                                            <option value="{{ $assessmentDetail->manualoverride_condition }}"
                                                selected>{{ $assessmentDetail->manualoverride_condition }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_11" name="health_rating_11"
                                        ...
                                        @if (!empty($assessmentDetail->manualoverride_condition_level))
                                            <option value="{{ $assessmentDetail->manualoverride_condition_level }}"
                                                selected>{{ $healthRatingByDevice->manualoverride }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                            ...
                            <div class="lg:w-1/2 pr-4 pl-4 md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="valve_condition_12" name="valve_condition_12"
                                        ...
                                        @if (!empty($assessmentDetail->positioneracc_condition))
                                            <option value="{{ $assessmentDetail->positioneracc_condition }}"
                                                selected>{{ $assessmentDetail->positioneracc_condition }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                            ...
                            <div class="lg:w-1/2 pr-4 pl-4 md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="health_rating_12" name="health_rating_12"
                                        ...
                                        data-change="false">
                                        @if (!empty($assessmentDetail->positioneracc_condition_level))
                                            <option value="{{ $assessmentDetail->positioneracc_condition_level }}"
                                                selected>{{ $healthRatingByDevice->positioneracc }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                            ...
                            <div class="md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="potensial_cause_12" name="potensial_cause_12[]"
                                        ...
                                        data-change="false" multiple>
                                        @if (!empty($assessmentDetail->positioneracc_cause))
                                            @foreach (explode('|', $assessmentDetail->positioneracc_cause) as $item)
                                                <option value="{{ $item }}" selected>{{ $item }}
                                                </option>
                                            @endforeach
                                        @endif
                            ...
                            <div class="md:w-full">
                                <div class="mb-4">
                                    ...
                                    <select id="recommendation_12" name="recommendation_12[]"
                                        ...
                                        data-change="false" multiple>
                                        @if (!empty($assessmentDetail->positioneracc_recommendation))
                                            @foreach (explode('|', $assessmentDetail->positioneracc_recommendation) as $item)
                                                <option value="{{ $item }}" selected>{{ $item }}
                                                </option>
                                            @endforeach
                                        @endif
