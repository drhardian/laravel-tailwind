...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS6" aria-expanded="false" aria-controls="collapseAS6">
                Body Bolts & Nuts
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS7" aria-expanded="false" aria-controls="collapseAS7">
                Actuator External Condition
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS8" aria-expanded="false" aria-controls="collapseAS8">
                Electrical Enclosure
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS9" aria-expanded="false" aria-controls="collapseAS9">
                Seals
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS10" aria-expanded="false" aria-controls="collapseAS10">
                Gear Box
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS11" aria-expanded="false" aria-controls="collapseAS11">
                Manual Override
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
...
<div class="row">
    <div class="col-md-12">
        <div class="expanel expanel-default">
            <div class="expanel-heading clearfix" data-toggle="collapse" data-target="#collapseAS12" aria-expanded="false" aria-controls="collapseAS12">
                Positioner & Accessories
                {{-- <div class="float-right">
                    <button class="btn btn-sm btn-light" type="button">
                        <i class="fa-solid fa-bars"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="valve_condition_12" name="valve_condition_12" class="form-control select2-dropdown-ajax select2-dropdown-ajax-new"
                                        ...
                                        @if (!empty($assessmentDetail->positioneracc_condition))
                                            <option value="{{ $assessmentDetail->positioneracc_condition }}" selected>{{ $assessmentDetail->positioneracc_condition }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="health_rating_12" name="health_rating_12" class="form-control select2-dropdown-ajax"
                                        ...
                                        @if (!empty($assessmentDetail->positioneracc_condition_level))
                                            <option value="{{ $assessmentDetail->positioneracc_condition_level }}" selected>{{ $healthRatingByDevice->positioneracc }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
