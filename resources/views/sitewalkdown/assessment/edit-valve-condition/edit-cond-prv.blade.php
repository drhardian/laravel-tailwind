                                ...
                                <div class="form-group">
                                    ...
                                    <select id="valve_condition_3" name="valve_condition_3" class="form-control select2-dropdown-ajax select2-dropdown-ajax-new"
                                        ...
                                        @if (!empty($assessmentDetail->bolt_nut_condition))
                                            <option value="{{ $assessmentDetail->bolt_nut_condition }}" selected>{{ $assessmentDetail->bolt_nut_condition }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="health_rating_3" name="health_rating_3" class="form-control select2-dropdown-ajax"
                                        ...
                                        @if (!empty($assessmentDetail->bolt_nut_condition_level))
                                            <option value="{{ $assessmentDetail->bolt_nut_condition_level }}" selected>{{ $healthRatingByDevice->boltnut }}</option>
                                        @else
                                            <option value="" disabled selected></option>
                                        @endif
                                    </select>
