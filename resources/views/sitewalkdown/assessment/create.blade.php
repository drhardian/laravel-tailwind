            ...
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div
                    ...
                    <ul class="flex flex-wrap mb-2 text-sm font-medium text-center assessment-panels" id="default-tab"
                        ...
                        <li class="me-2" role="presentation">
                            <button
                                class="hidden tab3menu p-4 border-b-2 rounded-t-lg text-white hover:text-blue-600 hover:border-gray-300 dark:hover:text-gray-300"
                        ...
                        <li role="presentation">
                            <button
                                class="hidden tab4menu p-4 border-b-2 rounded-t-lg text-white hover:text-blue-600 hover:border-gray-300 dark:hover:text-gray-300"
                ...
                <div class=" p-2 bg-white rounded-lg md:p-3 dark:bg-gray-800">
                    ...
                    <form id="assessmentForm" action="#">
                        ...
                        <div id="default-tab-content">
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="tab3" role="tabpanel"
                            ...
                            <div class="hidden p-4 rounded-lg bg-white dark:bg-gray-800" id="tab4" role="tabpanel"
                                                                        ...
                                                                        <div class="relative flex items-stretch w-full">
                                                                            <div class="input-group-prepend">
                                                                                <span
                                                                                    ...
                                                                                    name="health_priority_rating_color"></span>
                                                                            </div>
                                                                            <input type="text"
                                                                                class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"
                                                            ...
                                                            <div class="flex flex-wrap ">
                                                                <div class="md:w-full pr-4 pl-4">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <textarea
                                                                            class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"
                                                                            id="final_recommendation" name="final_recommendation" rows="3"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="md:w-full pr-4 pl-4">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <select id="leak_detection_method"
                                                                            ...
                                                                            <option value="0">2 Point</option>
                                                                            <option value="1">4 Point</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="md:w-1/3 pr-4 pl-4">
                                                        <div class="mb-4">
                                                            ...
                                                            <select id="rigging_point_needed" name="rigging_point_needed"
                                                                ...
                                                                <option value="Data Not Available">Data Not Available
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="md:w-1/2 pr-2 pl-2 text-right">
                                            ...
                                            <div id="dropdown"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onclick="saveAssessment(1)"><i
                                                            class="fa-solid fa-check-double mr-2"></i>Complete</a>
                                                    </li>
                                                    <li>
                                                        <a href="#"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onclick="saveAssessment(0)"><i
...
@section('js')
    ...
    <script src="{{ asset('core/js/sitewalkdown/assessment/create-functions.js') }}?v=1.0"></script>
    <script>
