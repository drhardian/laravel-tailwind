                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="doubleblock_bleed" name="doubleblock_bleed" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="multi_turn" name="multi_turn" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="torque_seated" name="torque_seated" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="quarter_turn" name="quarter_turn" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="position_seated" name="position_seated" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="local_control" name="local_control" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="remote_control" name="remote_control" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select id="actuator_ratio" name="actuator_ratio" class="form-control select2-static">
                                <option value="" selected></option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
