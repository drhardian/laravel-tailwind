    ...
    <div class="md:w-full pr-4 pl-4">
        <details class="border mt-4 rounded-t-sm">
            ...
            <div class="expanel-body" id="collapseAS1">
                <div class="flex flex-wrap ">
                    <div class="md:w-1/2 pr-4 pl-4 sm:w-full pr-4 pl-4">
                        <div class="mb-4">
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-1/2 pr-4 pl-4 md:w-full pr-4 pl-4 sm:w-full pr-4 pl-4">
                        <div class="mb-4">
...
<div class="flex flex-wrap ">
    <div class="md:w-full pr-4 pl-4">
        <details class="border mt-4 rounded-t-sm">
            <summary  class="question py-3 px-4 rounded-t-sm bg-blue-100 cursor-pointer focus:ring-4 focus:ring-blue-200 hover:bg-blue-400 dark:hover:bg-gray-800 gap-3 select-none w-full outline-none text-gray-700 font-semibold border-gray-200">
                Pressure Seal Gasket Area
            </summary>
                    ...
                    <div class="lg:w-1/2 pr-4 pl-4 md:w-full pr-4 pl-4 sm:w-full pr-4 pl-4">
                        <div class="mb-4">
                            ...
                            <select id="potensial_cause_13" name="potensial_cause_13[]"
                                ...
                                data-show="{{ route('swd.dropdowns.showpotensialcausedropdowns') }}"
                                data-store="{{ route('swd.dropdowns.storenewpotensialcausedropdown') }}"
                                data-form="potensial_cause_13" data-alias="AS13" data-scope="" data-change="false"
                                multiple>
                            </select>
                        </div>
                    </div>
                    <div class="lg:w-1/2 pr-4 pl-4 md:w-full pr-4 pl-4 sm:w-full pr-4 pl-4">
                        <div class="mb-4">
                            ...
                            <select id="recommendation_13" name="recommendation_13[]"
                                ...
                                data-show="{{ route('swd.dropdowns.showrecommendationdropdowns') }}"
                                data-store="{{ route('swd.dropdowns.storenewrecommendationdropdown') }}"
                                data-form="recommendation_13" data-alias="AS13" data-scope="" data-change="false"
                                multiple>
                            </select>
                        </div>
                    </div>
