        ...
        <div class="p-4 mt-2">
            ...
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class=" p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800">
                    <div id="errors"></div>
                    <input type="hidden" id="instruction_store_url" name="instruction_store_url"
                        value="{{ route('swd.instructions.store') }}">
                            ...
                            <div class="flex flex-row-reverse">
                                <div class=" mt-3">
                                    ...
                                    <a href="{{ route('swd.instructions.index') }}"
                                        class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"><i class="fas fa-times mr-1"></i>Cancel</a>

                                    <button id="dropdownSaveButton" data-dropdown-toggle="dropdownSave"
                                        class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-orange-500 dark:hover:bg-orange-600 dark:focus:ring-blue-800"
                                        type="button"><i class="fas fa-check mr-2"></i>Save <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true"
                                    ...
                                    <div id="dropdownSave"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="dropdownSaveButton">
                                            <li>
                                                <a href="#" onclick="saveInstruction(0)"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><i
                                                    class="fa-brands fa-firstdraft mr-2"></i>Save</a>
                                            </li>
                                            <li>
                                                <a href="#" onclick="saveInstruction(1)"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><i
                                                    class="fa-solid fa-check-double mr-2"></i>Save & Create SWD</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
@section('js')
    ...
    <script src="{{ asset('core/js/sitewalkdown/instruction/create-functions.js') }}"></script>
    <script>
