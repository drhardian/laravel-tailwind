...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('prv_assessments', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('bolt_nut_condition')->nullable();
            $table->string('bolt_nut_condition_level')->nullable();
            $table->longText('bolt_nut_cause')->nullable();
            $table->longText('bolt_nut_recommendation')->nullable();
    ...
    {
        Schema::dropIfExists('prv_assessments');
    }
};
