...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('swd_isv_assessments', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('oilleak_condition')->nullable();
            $table->string('oilleak_condition_level')->nullable();
            $table->longText('oilleak_cause')->nullable();
            $table->longText('oilleak_recommendation')->nullable();
            ...
            $table->string('accessories_condition')->nullable();
            $table->string('accessories_condition_level')->nullable();
            $table->longText('accessories_cause')->nullable();
            $table->longText('accessories_recommendation')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('swd_isv_assessments');
    }
};
